    ...
    public static class ResourceManager
    {
        ...
        public static byte[] SteamVR
        {
            get
            {
                ...
                {
                    return Properties.Resources.vrgin_5_0;
                }
                if(VERSION.CompareTo("5.2") <= 0)
                {
                    return Properties.Resources.vrgin_5_2;
                }
                if(VERSION.CompareTo("5.3") <= 0)
                {
                    return Properties.Resources.vrgin_5_3;
                }
                if(VERSION.CompareTo("5.4") <= 0)
                {
                    return Properties.Resources.vrgin_5_4;
                }
                if (VERSION.CompareTo("5.5") <= 0)
                {
                    return Properties.Resources.vrgin_5_5;
                }
                
                return Properties.Resources.vrgin_5_6;
            }
        }
        ...
        public static byte[] Hands
        {
            get
            {
                return Properties.Resources.hands_5_3;
            }
        }
